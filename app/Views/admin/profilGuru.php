        ...
        <div class="container-fluid">
            ...
            <div class="card card-info">
                ...
                <form class="form-horizontal" action="/editBiodataGuru" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?= session('teacher_id') ?>">
                    <div class="card-body">
                        <h5>A. BIODATA</h5>
                        <hr>
                        <div class="px-4 mb-5">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="position" id="position" required>
                                        <option value="Kepala Sekolah" <?php echo $data['user']->position == "Kepala Sekolah" ? 'selected' : ''; ?>>Kepala Sekolah</option>
                                        <option value="Staff" <?php echo $data['user']->position == "Staff" ? 'selected' : ''; ?>>Staff</option>
                                        <option value="Guru" <?php echo $data['user']->position == "Guru" ? 'selected' : ''; ?>>Guru</option>
                                    </select>
                                </div>
                            </div>
                        </div>
